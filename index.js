...
console.log(`You choose ${userPreference} Monster Energy drink`);
...
console.log(`There are ${cansLeft} cans left of ${userPreference} Monster Energy drink left.`);
